...
## Project Structure
    ...
    ├── testjhsddsjcbdcdscd_52726  # Django project configurations
...
1. Clone this repo and `cd testjhsddsjcbdcdscd_52726`
...
2. Clone this repo and `cd testjhsddsjcbdcdscd_52726`
